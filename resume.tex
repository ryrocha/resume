...
% page layout
\geometry{left=1.5cm,right=9.1cm,marginparwidth=6.8cm,marginparsep=0.8cm,top=1.25cm,bottom=1.25cm}
...
\begin{document}
  ...
  \personalinfo{%
    \email{rarocha@ucdavis.edu}
    \location{Davis, CA}
    \linkedin{linkedin.com/in/ryan-rocha}
    \github{github.com/ryrocha} 
}
...
\cvevent{}{Undergraduate Student Researcher}{March 2017 -- September 2017}{Davis, CA}
\begin{itemize}
...
\cvevent{}{Student Engineering Assistant}{October 2014 -- June 2016}{Davis, CA}
\begin{itemize}
